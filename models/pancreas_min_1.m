...
% Compartment: id = Vpa, name = pancreas tissue
% Warning compartment Vpa has no rule and is not constant
% Compartment: id = Vext, name = pancreas blood
% Warning compartment Vext has no rule and is not constant
